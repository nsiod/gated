...
pub(crate) fn _default_metrics_listen() -> ListenEndpoint {
    use std::net::Ipv4Addr;
    // Prometheus default exporter port, bound to loopback only.
    ListenEndpoint::from(SocketAddr::new(Ipv4Addr::LOCALHOST.into(), 9090))
}
...
#[inline]
pub(crate) fn _default_log_file_prefix() -> String {
    "gated".to_owned()
}

#[inline]
pub(crate) fn _default_otlp_service_name() -> String {
    "gated".to_owned()
}
