...
pub struct GatedClaims {
    #[serde(default, deserialize_with = "string_or_vec")]
    pub gated_roles: Option<Vec<String>>,
}

impl AdditionalClaims for GatedClaims {}

pub struct SsoResult {
    pub token: CoreIdToken,
    pub claims: CoreIdTokenClaims,
    pub userinfo_claims: Option<UserInfoClaims<GatedClaims, CoreGenderClaim>>,
}
...
impl SsoClient {
    ...
    pub async fn finish_login(
        ...
        let userinfo_claims: Option<UserInfoClaims<GatedClaims, CoreGenderClaim>> =
