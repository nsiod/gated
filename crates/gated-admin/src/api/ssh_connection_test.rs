use gated_common::{GatedError, SSHTargetAuth, SshTargetPasswordAuth, TargetSSHOptions};
use gated_core::Services;
use gated_protocol_ssh::{RCCommand, RCEvent, RemoteClient};
use poem::web::Data;
...
impl Api {
    ...
    ) -> Result<CheckSshHostKeyResponse, GatedError> {
