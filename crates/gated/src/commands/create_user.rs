use gated_common::{
    GatedError, GlobalParams, Secret, UserPasswordCredential, UserRequireCredentialsPolicy,
};
use gated_core::Services;
use gated_db_entities::{PasswordCredential, Role, User, UserRoleAssignment};
